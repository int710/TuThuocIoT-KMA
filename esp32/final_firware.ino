...
String ssid = "NGOC KHANH";
String pass = "09032022";
...
void startReminder(int idx) {
  ...
  String msg = "⏰ MEDICINE REMINDER\n";
  msg += "Medicine: " + medicines[idx].name + "\n";
  msg += "Quantity left: " + String(medicines[idx].qty) + "\n";
  msg += "Please take your medicine within " + String(medicines[idx].timeout) + " minutes";
...
void confirmMedicine(int idx) {
  ...
  String msg = "✅ XÁC NHẬN THUỐC ĐÃ UỐNG\n";
  msg += "Tên thuốc: " + medicines[idx].name + "\n";
  msg += "Thời gian: " + getTimestamp() + "\n";
  msg += "Số lượng còn lại: " + String(medicines[idx].qty);
